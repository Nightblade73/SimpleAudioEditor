...
namespace SimpleAudioEditor.Controller.Editor
{
    class SoundLineEditor
    {
        ...
        public Segment GetSegment()
        {
            ...
            Bitmap CroppedImage = CropImage(DrawWave(new Pen(Params.myColor), pictureBox.Size.Width - 20, pictureBox.Size.Height), section);
        //    CroppedImage = ResizeImage(CroppedImage, new Size(cr,));
            return new Segment(SplitStartTimeFromSecond(), SplitEndTimeFromSecond(), soundTotalTime, filePath, CroppedImage);
        }
        ...
        protected void pictureBox_Paint(object sender, PaintEventArgs e)
        {
            ...
            if (draw) {
                e.Graphics.DrawImage( DrawWave(new Pen(Params.myColor), pictureBox.Size.Width - 20, pictureBox.Size.Height),10,0);
            ...
            */
            ...
            else
            {
                ...
                e.Graphics.FillRectangle(new SolidBrush(Params.myColor), rect);
            }
            /*
            Rectangle rect = new Rectangle(
